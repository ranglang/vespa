...
public interface AccessControlManager {
     ...
     *
     * @param tenantSpecification permit for the tenant to create
     ...
     */
    Tenant createTenant(TenantSpecification tenantSpecification, List<Tenant> existing, List<Application> applications);

    /**
     * Removes all permissions for tenant in the given permit, and for any applications it owns, or throws.
     *
     * @param tenantSpecification permit for the tenant to delete
     * @param tenant the tenant to delete
     * @param applications list of applications this tenant owns
     */
    void deleteTenant(TenantSpecification tenantSpecification, Tenant tenant, List<Application> applications);
